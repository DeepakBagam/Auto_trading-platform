...
def build_order_notification_message(
    ...
    balance_before = _float_or_none(payload.get("balance_before_trade"))
    balance_after = _float_or_none(payload.get("balance_after_trade"))
    ...
    text_lines = [
        ...
        f"Balance Before Trade: {_format_money(balance_before)}",
        f"Balance After Trade: {_format_money(balance_after)}",
    ...
    html_rows = [
        ...
        ("Balance Before Trade", _format_money(balance_before)),
        ("Balance After Trade", _format_money(balance_after)),
