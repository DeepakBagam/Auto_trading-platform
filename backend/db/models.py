...
class AuditLog(Base):
    ...
    __table_args__ = (
        Index("ix_audit_logs_created_action_status", "created_at", "action", "status"),
        Index("ix_audit_logs_resource_resource_id", "resource", "resource_id", "created_at"),
    )
    ...
    status: Mapped[str] = mapped_column(String(32), index=True, default="INFO")
